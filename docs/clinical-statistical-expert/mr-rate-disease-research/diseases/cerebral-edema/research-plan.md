# Cerebral edema Research Plan

Status: not_started

## Scope Definition

- Disease or finding: Cerebral edema
- MR-RATE original name: Cerebral edema
- Ontology source: snomed
- SNOMED CT: 2032001 (Cerebral edema)
...
1. Describe how Cerebral edema is expected to present on diagnostic imaging, especially MRI, using radiology-report style language.
2. Identify findings that support or argue against Cerebral edema relative to common mimics and relevant MR-RATE categories.
...
```text
As a radiology expert, given a diagnosis of Cerebral edema, what would you look for in MRI images to confirm?
```

Advanced prompt:

```text
As a neuroradiologist, given a diagnosis of Cerebral edema, what sequence-specific MRI signal characteristics, lesion morphology, anatomic distribution, chronicity features, volume-loss patterns, and associated findings would you expect to see on MRI?
```

Search variants:

- Cerebral edema MRI imaging characteristics
- Cerebral edema MRI T1 T2 FLAIR DWI ADC SWI contrast signal characteristics
- Cerebral edema MRI lesion morphology anatomic distribution
- Cerebral edema MRI chronicity features structural patterns
- Cerebral edema MRI associated findings radiology
- Cerebral edema MRI differential diagnosis mimics
- Cerebral edema MRI report language findings impression
- Cerebral edema clinical course progression stable treatment response
- Cerebral edema cohort definition endpoint misclassification adjudication
