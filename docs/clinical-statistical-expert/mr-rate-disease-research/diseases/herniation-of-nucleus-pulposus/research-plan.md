# Herniation of nucleus pulposus Research Plan

Status: not_started

## Scope Definition

- Disease or finding: Herniation of nucleus pulposus
- MR-RATE original name: Disc herniation
- Ontology source: snomed
- SNOMED CT: 84857004 (Herniation of nucleus pulposus)
- Cluster: spine
...
1. Describe how Herniation of nucleus pulposus is expected to present on diagnostic imaging, especially MRI, using radiology-report style language.
2. Identify findings that support or argue against Herniation of nucleus pulposus relative to common mimics and relevant MR-RATE categories.
...
```text
As a radiology expert, given a diagnosis of Herniation of nucleus pulposus, what would you look for in MRI images to confirm?
```

Advanced prompt:

```text
As a neuroradiologist, given a diagnosis of Herniation of nucleus pulposus, what sequence-specific MRI signal characteristics, lesion morphology, anatomic distribution, chronicity features, volume-loss patterns, and associated findings would you expect to see on MRI?
```

Search variants:

- Herniation of nucleus pulposus MRI imaging characteristics
- Herniation of nucleus pulposus MRI T1 T2 FLAIR DWI ADC SWI contrast signal characteristics
- Herniation of nucleus pulposus MRI lesion morphology anatomic distribution
- Herniation of nucleus pulposus MRI chronicity features structural patterns
- Herniation of nucleus pulposus MRI associated findings radiology
- Herniation of nucleus pulposus MRI differential diagnosis mimics
- Herniation of nucleus pulposus MRI report language findings impression
- Herniation of nucleus pulposus clinical course progression stable treatment response
- Herniation of nucleus pulposus cohort definition endpoint misclassification adjudication
