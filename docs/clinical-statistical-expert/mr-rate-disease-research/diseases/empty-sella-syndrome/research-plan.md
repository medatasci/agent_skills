# Empty sella syndrome Research Plan

Status: not_started

## Scope Definition

- Disease or finding: Empty sella syndrome
- MR-RATE original name: Empty sella
- Ontology source: snomed
- SNOMED CT: 237722004 (Empty sella syndrome)
...
1. Describe how Empty sella syndrome is expected to present on diagnostic imaging, especially MRI, using radiology-report style language.
2. Identify findings that support or argue against Empty sella syndrome relative to common mimics and relevant MR-RATE categories.
...
```text
As a radiology expert, given a diagnosis of Empty sella syndrome, what would you look for in MRI images to confirm?
```

Advanced prompt:

```text
As a neuroradiologist, given a diagnosis of Empty sella syndrome, what sequence-specific MRI signal characteristics, lesion morphology, anatomic distribution, chronicity features, volume-loss patterns, and associated findings would you expect to see on MRI?
```

Search variants:

- Empty sella syndrome MRI imaging characteristics
- Empty sella syndrome MRI T1 T2 FLAIR DWI ADC SWI contrast signal characteristics
- Empty sella syndrome MRI lesion morphology anatomic distribution
- Empty sella syndrome MRI chronicity features structural patterns
- Empty sella syndrome MRI associated findings radiology
- Empty sella syndrome MRI differential diagnosis mimics
- Empty sella syndrome MRI report language findings impression
- Empty sella syndrome clinical course progression stable treatment response
- Empty sella syndrome cohort definition endpoint misclassification adjudication
