# Spinal cord compression Research Plan

Status: not_started

## Scope Definition

- Disease or finding: Spinal cord compression
- MR-RATE original name: Spinal cord compression
- Ontology source: snomed
- SNOMED CT: 71286001 (Spinal cord compression)
- Cluster: spine
...
1. Describe how Spinal cord compression is expected to present on diagnostic imaging, especially MRI, using radiology-report style language.
2. Identify findings that support or argue against Spinal cord compression relative to common mimics and relevant MR-RATE categories.
...
```text
As a radiology expert, given a diagnosis of Spinal cord compression, what would you look for in MRI images to confirm?
```

Advanced prompt:

```text
As a neuroradiologist, given a diagnosis of Spinal cord compression, what sequence-specific MRI signal characteristics, lesion morphology, anatomic distribution, chronicity features, volume-loss patterns, and associated findings would you expect to see on MRI?
```

Search variants:

- Spinal cord compression MRI imaging characteristics
- Spinal cord compression MRI T1 T2 FLAIR DWI ADC SWI contrast signal characteristics
- Spinal cord compression MRI lesion morphology anatomic distribution
- Spinal cord compression MRI chronicity features structural patterns
- Spinal cord compression MRI associated findings radiology
- Spinal cord compression MRI differential diagnosis mimics
- Spinal cord compression MRI report language findings impression
- Spinal cord compression clinical course progression stable treatment response
- Spinal cord compression cohort definition endpoint misclassification adjudication
