...
Status: final evidence-count target met; needs human expert review before
publication.
...
- Video evidence manifest: `cerebral-infarction.videos.json`
- Research plan: `cerebral-infarction.research-plan.md`

This draft now meets the requested evidence-count target with 50 source
records, 25 image or figure evidence records, and 15 video evidence records.
It should be treated as a mature review package for expert review, not as a
clinically finalized chapter. The remaining work is deeper extraction,
transcript review, source-quality grading, and human clinical-statistical
adjudication.
...
- DWI lesion-pattern examples, serial DWI/ADC/FLAIR evolution, CT/MR perfusion
  examples, and CT early-ischemia signs from open-access review articles
- DWI-FLAIR mismatch, PWI/DWI mismatch, and arterial-territory atlas figures
  from open-access stroke imaging and vascular-territory literature
