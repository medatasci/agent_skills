# Foraminal Spinal Stenosis Research Plan

Status: not_started

## Scope Definition

- Disease or finding: Foraminal Spinal Stenosis
- MR-RATE original name: Foraminal stenosis
- Ontology source: radlex
- RadLex: http://www.radlex.org/RID/#RID5034 (foraminal spinal stenosis)
- Cluster: spine
...
1. Describe how Foraminal Spinal Stenosis is expected to present on diagnostic imaging, especially MRI, using radiology-report style language.
2. Identify findings that support or argue against Foraminal Spinal Stenosis relative to common mimics and relevant MR-RATE categories.
...
```text
As a radiology expert, given a diagnosis of Foraminal Spinal Stenosis, what would you look for in MRI images to confirm?
```

Advanced prompt:

```text
As a neuroradiologist, given a diagnosis of Foraminal Spinal Stenosis, what sequence-specific MRI signal characteristics, lesion morphology, anatomic distribution, chronicity features, volume-loss patterns, and associated findings would you expect to see on MRI?
```

Search variants:

- Foraminal Spinal Stenosis MRI imaging characteristics
- Foraminal Spinal Stenosis MRI T1 T2 FLAIR DWI ADC SWI contrast signal characteristics
- Foraminal Spinal Stenosis MRI lesion morphology anatomic distribution
- Foraminal Spinal Stenosis MRI chronicity features structural patterns
- Foraminal Spinal Stenosis MRI associated findings radiology
- Foraminal Spinal Stenosis MRI differential diagnosis mimics
- Foraminal Spinal Stenosis MRI report language findings impression
- Foraminal Spinal Stenosis clinical course progression stable treatment response
- Foraminal Spinal Stenosis cohort definition endpoint misclassification adjudication
