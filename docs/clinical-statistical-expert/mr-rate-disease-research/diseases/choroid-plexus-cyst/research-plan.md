# Choroid plexus cyst Research Plan

Status: not_started

## Scope Definition

- Disease or finding: Choroid plexus cyst
- MR-RATE original name: Choroid plexus cyst
- Ontology source: snomed
- SNOMED CT: 230790004 (Choroid plexus cyst)
...
1. Describe how Choroid plexus cyst is expected to present on diagnostic imaging, especially MRI, using radiology-report style language.
2. Identify findings that support or argue against Choroid plexus cyst relative to common mimics and relevant MR-RATE categories.
...
```text
As a radiology expert, given a diagnosis of Choroid plexus cyst, what would you look for in MRI images to confirm?
```

Advanced prompt:

```text
As a neuroradiologist, given a diagnosis of Choroid plexus cyst, what sequence-specific MRI signal characteristics, lesion morphology, anatomic distribution, chronicity features, volume-loss patterns, and associated findings would you expect to see on MRI?
```

Search variants:

- Choroid plexus cyst MRI imaging characteristics
- Choroid plexus cyst MRI T1 T2 FLAIR DWI ADC SWI contrast signal characteristics
- Choroid plexus cyst MRI lesion morphology anatomic distribution
- Choroid plexus cyst MRI chronicity features structural patterns
- Choroid plexus cyst MRI associated findings radiology
- Choroid plexus cyst MRI differential diagnosis mimics
- Choroid plexus cyst MRI report language findings impression
- Choroid plexus cyst clinical course progression stable treatment response
- Choroid plexus cyst cohort definition endpoint misclassification adjudication
